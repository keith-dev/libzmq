...
#ifndef __ZMQ_RAW_HPP_INCLUDED__
#define __ZMQ_RAW_HPP_INCLUDED__
...
class raw_t ZMQ_FINAL : public routing_socket_base_t
{
  public:
    raw_t (zmq::ctx_t *parent_, uint32_t tid_, int sid_);
    ~raw_t ();
  ...
  private:
    ...
    ZMQ_NON_COPYABLE_NOR_MOVABLE (raw_t)
};
}
